...
import axios from "axios"; // If you use fetch, let me know, I can adjust.
  ...
  useEffect(() => {
    const fetchDoctor = async () => {
      try {
        ...
        // Process appointments into a date -> [times] format
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {timeSlots.map((time) => {
              ...
              // Convert the selected date and time into a full datetime
              ...
              const isPast = isToday && slotDateTime.isBefore(dayjs());
